#couldn't import logo from art for some reason, so imma just do this
print("""           
...
def caesar(plain_text,shift_amount,cipher_direction):
    ...
    for letter in plain_text:
        if letter in alphabet:
            ...
            word+= alphabet[(x+shift_amount)%len(alphabet)]
        else:
            word+= letter
...
while retry:
    ...
    retry = input("Would you like to restart the code?\n")
    if retry == "no":
        retry = False
...
#Caesar 3 
#TODO-1: Combine the encrypt() and decrypt() functions into a single function called caesar(). 
#TODO-2: Call the caesar() function, passing over the 'text', 'shift' and 'direction' values.A